...
serve(async (req) => {
  ...
  try {
    ...
    const systemPrompt = `You are an expert SEO content writer and digital strategist for AION (https://mindos.space) — a gamified personal development platform that uses AI coaching, orb-based digital identity, and neuroscience-backed tools.
...
Every article MUST naturally reference and link to at least 3 AION features. Weave them as real solutions, not ads:

1. **AION Coach** — 24/7 personalized AI life coach. Link: <a href="https://mindos.space/">Try AION free →</a>
...
INTEGRATION RULES:
- Include a "How AION Approaches This" H2 section near the end
- Final CTA: "Ready to [benefit]? <a href="https://mindos.space/">Start your free AION journey →</a>"
...
JSON structure:
{
  ...
  "content": "Full English article with AION product references in semantic HTML",
  "content_he": "Full Hebrew article with AION product references in semantic HTML",
  "meta_title": "SEO title (60 chars)",
  "meta_description": "Meta description (160 chars)",
  "meta_keywords": "comma,separated,keywords,AION,AI coaching",
  "tags": ["tag1", "tag2", "tag3"],
