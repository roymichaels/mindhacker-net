...
## כלל ניקוד — חובה!
**כל טקסט בעברית חייב להיכתב עם ניקוד מלא (נִקּוּד).** כל מילה בעברית חייבת לכלול את כל סימני הניקוד (פַּתָּח, קָמָץ, צֵירֵי, סֶגוֹל, חִירִיק, שׁוּרוּק, חוֹלָם, קוּבּוּץ, שְׁוָא, דָּגֵשׁ). זה חל על כל תגובה, כל משפט, בלי יוצא מן הכלל.
