  ...
  steps: [
    ...
    // ─── Step 13.5: Exercise & Body ───
    {
      ...
      miniSteps: [
        ...
        {
          id: 'exercise_types',
          title_he: 'אילו סוגי אימון אתה עושה כרגע? (בחר הכל)',
          title_en: 'What types of exercise do you currently do? (select all)',
          inputType: 'multi_select',
          options: [
            ...
            { value: 'cardio', label_he: 'קרדיו (ריצה)', label_en: 'Cardio (running)', icon: '🏃' },
            { value: 'martial_arts', label_he: 'אומנויות לחימה', label_en: 'Martial arts', icon: '🥊' },
            ...
            { value: 'climbing', label_he: 'טיפוס', label_en: 'Climbing', icon: '🧗' },
            { value: 'hiking', label_he: 'טיולים / הליכה בטבע', label_en: 'Hiking', icon: '🥾' },
            { value: 'tennis', label_he: 'טניס / פאדל', label_en: 'Tennis / Padel', icon: '🎾' },
            { value: 'boxing', label_he: 'אגרוף / קיקבוקס', label_en: 'Boxing / Kickboxing', icon: '🥋' },
            { value: 'surfing', label_he: 'גלישה', label_en: 'Surfing', icon: '🏄' },
            { value: 'cycling', label_he: 'רכיבת אופניים', label_en: 'Cycling', icon: '🚴' },
            { value: 'stretching', label_he: 'מתיחות / גמישות', label_en: 'Stretching / Flexibility', icon: '🤸' },
            { value: 'parkour', label_he: 'פארקור', label_en: 'Parkour', icon: '🏃‍♂️' },
            { value: 'tricking', label_he: 'טריקינג', label_en: 'Tricking', icon: '🌀' },
            { value: 'breakdance', label_he: 'ברייקדאנס', label_en: 'Breakdance', icon: '🕺' },
            { value: 'acrobatics', label_he: 'אקרובטיקה / ג׳ימנסטיקה', label_en: 'Acrobatics / Gymnastics', icon: '🤸‍♂️' },
            { value: 'animal_flow', label_he: 'אנימל פלואו / תנועה', label_en: 'Animal Flow / Movement', icon: '🐒' },
            { value: 'capoeira', label_he: 'קפוארה', label_en: 'Capoeira', icon: '🇧🇷' },
            { value: 'olympic_lifting', label_he: 'הרמת משקולות אולימפית', label_en: 'Olympic weightlifting', icon: '🏅' },
            { value: 'powerlifting', label_he: 'פאוורליפטינג', label_en: 'Powerlifting', icon: '🔩' },
            { value: 'hiit', label_he: 'HIIT / אינטרוולים', label_en: 'HIIT / Intervals', icon: '🔥' },
            { value: 'rowing', label_he: 'חתירה', label_en: 'Rowing', icon: '🚣' },
            { value: 'skateboarding', label_he: 'סקייטבורד', label_en: 'Skateboarding', icon: '🛹' },
            { value: 'skiing', label_he: 'סקי / סנובורד', label_en: 'Skiing / Snowboard', icon: '⛷️' },
            { value: 'pole_dance', label_he: 'פול דאנס / אריאל', label_en: 'Pole / Aerial', icon: '🎪' },
            { value: 'trx', label_he: 'TRX / רצועות', label_en: 'TRX / Suspension', icon: '🪢' },
            { value: 'kettlebell', label_he: 'קטלבלס', label_en: 'Kettlebells', icon: '🔔' },
            { value: 'sprinting', label_he: 'ספרינט / אתלטיקה', label_en: 'Sprinting / Track', icon: '🏅' },
            { value: 'jump_rope', label_he: 'קפיצה בחבל', label_en: 'Jump rope', icon: '⏭️' },
            { value: 'tai_chi', label_he: 'טאי צ׳י / צ׳י גונג', label_en: 'Tai Chi / Qigong', icon: '☯️' },
            { value: 'racquet_sports', label_he: 'בדמינטון / סקווש', label_en: 'Badminton / Squash', icon: '🏸' },
            { value: 'wrestling', label_he: 'היאבקות / ג׳יו ג׳יטסו', label_en: 'Wrestling / BJJ', icon: '🤼' },
            { value: 'fencing', label_he: 'סיוף', label_en: 'Fencing', icon: '🤺' },
            { value: 'archery', label_he: 'קשתות', label_en: 'Archery', icon: '🏹' },
            { value: 'horse_riding', label_he: 'רכיבה על סוסים', label_en: 'Horse riding', icon: '🏇' },
            { value: 'stand_up_paddle', label_he: 'סאפ (SUP)', label_en: 'Stand-up paddle', icon: '🛶' },
            { value: 'diving', label_he: 'צלילה', label_en: 'Diving', icon: '🤿' },
            { value: 'obstacle_race', label_he: 'מרוץ מכשולים', label_en: 'Obstacle race (OCR)', icon: '🏁' },
            { value: 'functional_bodybuilding', label_he: 'פיתוח גוף פונקציונלי', label_en: 'Functional bodybuilding', icon: '💎' },
            { value: 'mobility', label_he: 'מוביליטי / תיקון תנועה', label_en: 'Mobility / Movement prep', icon: '🔄' },
          ],
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_2_profile_data', jsonPath: 'exercise_types' },
        },
        {
          id: 'exercise_types_wanted',
          title_he: 'מה תרצה להתחיל לאמן? (בחר הכל)',
          title_en: 'What would you like to start training? (select all)',
          prompt_he: 'בחר אימונים חדשים שאתה רוצה להוסיף לשגרה שלך',
          prompt_en: 'Pick new training types you want to add to your routine',
          inputType: 'multi_select',
          options: [
            { value: 'nothing_new', label_he: 'מרוצה ממה שיש', label_en: 'Happy with what I do', icon: '✅' },
            { value: 'strength', label_he: 'אימון כוח / חדר כושר', label_en: 'Strength / gym', icon: '🏋️' },
            { value: 'cardio', label_he: 'קרדיו (ריצה)', label_en: 'Cardio (running)', icon: '🏃' },
            { value: 'martial_arts', label_he: 'אומנויות לחימה', label_en: 'Martial arts', icon: '🥊' },
            { value: 'yoga', label_he: 'יוגה / פילאטיס', label_en: 'Yoga / Pilates', icon: '🧘' },
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_2_profile_data', jsonPath: 'exercise_types_wanted' },
        },
      ],
    },
