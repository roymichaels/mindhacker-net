    ...
    // ─── STEP 2: Specific Tension (branched) ───
    {
      ...
      miniSteps: [
        // Mind tensions
        {
          ...
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('mentally_exhausted') : v === 'mentally_exhausted'; } },
        },
        // Career tensions
        {
          id: 'specific_tension',
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_1_intention', jsonPath: 'specific_tension' },
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('stuck_career') : v === 'stuck_career'; } },
        },
        // Money tensions
        {
          id: 'specific_tension',
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_1_intention', jsonPath: 'specific_tension' },
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('financially_stressed') : v === 'financially_stressed'; } },
        },
        // Relationships tensions
        {
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_1_intention', jsonPath: 'specific_tension' },
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('relationships_disconnected') : v === 'relationships_disconnected'; } },
        },
        // Structure/discipline tensions
        {
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_1_intention', jsonPath: 'specific_tension' },
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('lack_structure') : v === 'lack_structure'; } },
        },
        // Physical drain tensions
        {
          ...
          validation: { required: true, minSelected: 1 },
          dbPath: { table: 'launchpad_progress', column: 'step_1_intention', jsonPath: 'specific_tension' },
          branching: { showIf: (a) => { const v = a.friction_type; return Array.isArray(v) ? v.includes('physically_drained') : v === 'physically_drained'; } },
        },
      ],
    },
