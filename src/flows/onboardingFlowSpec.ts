  ...
  steps: [
    ...
    // ─── Step 13.5: Exercise & Body ───
    {
      ...
      miniSteps: [
        ...
        {
          id: 'exercise_types',
          title_he: 'אילו סוגי אימון אתה עושה או רוצה להתחיל? (בחר הכל)',
          title_en: 'What training do you do or want to start? (select all)',
          prompt_he: 'סמן את כל מה שאתה מתאמן כרגע + מה שתרצה להתחיל',
          prompt_en: 'Mark everything you currently train + what you want to start',
          inputType: 'multi_select',
          options: [
