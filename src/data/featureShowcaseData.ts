...
export const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    titleHe: 'שלוט בכל 14 תחומי החיים',
    hookEn: 'Your life. 14 domains. Measured. Engineered. Upgraded.',
    hookHe: 'החיים שלך. 14 תחומים. נמדדים. מתוכננים. משודרגים.',
    descEn: 'A structured system covering 14 life domains — 7 Core (Consciousness, Image, Power, Vitality, Focus, Combat, Expansion) and 7 Arena (Wealth, Influence, Relationships, Business, Projects, Play, Order) — each powered by advanced assessment engines and AI coaching.',
    descHe: 'מערכת מובנית שמכסה 14 תחומי חיים — 7 ליבה (תודעה, תדמית, עוצמה, חיוניות, מיקוד, לחימה, התרחבות) ו-7 זירה (עושר, השפעה, קשרים, עסקים, פרויקטים, משחק, סדר) — כל אחד מופעל על ידי מנועי הערכה מתקדמים ואימון AI.',
  },
  {
