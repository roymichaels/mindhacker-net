...
export const FEATURES: FeatureItem[] = [
  ...
  },
  {
    ...
    titleHe: 'שלוט בכל 15 תחומי החיים',
    hookEn: 'Your life. 15 domains. Measured. Engineered. Upgraded.',
    hookHe: 'החיים שלך. 15 תחומים. נמדדים. מתוכננים. משודרגים.',
    descEn: 'A structured system covering 15 unified life domains — Consciousness, Image, Power, Vitality, Focus, Combat, Expansion, Wealth, Influence, Relationships, Business, Projects, Play, Order, and Romantics — each powered by advanced assessment engines and AI coaching.',
    descHe: 'מערכת מובנית שמכסה 15 תחומי חיים מאוחדים — תודעה, תדמית, עוצמה, חיוניות, מיקוד, לחימה, התרחבות, עושר, השפעה, קשרים, עסקים, פרויקטים, משחק, סדר, ורומנטיקה — כל אחד מופעל על ידי מנועי הערכה מתקדמים ואימון AI.',
  },
  {
