...
const ADJ_HE = [
  ...
  'קר','אלמוגי','קוסמי','ארגמני','קריסטלי','מכושף','חשוך','שחרי','עמוק','איתן',
  ...
  'אדווה','עולה','נודד','רוני','חלוד','מקודש','חכם','חולמי','סאטן','פרא',
  ...
  'גאותי','טיטני','טופזי','עליון','בין ערביים','צל','אדי','עתידי','קטיפתי','ארצי',
...
const NOUN_HE = [
  ...
  'משי','נצח','שבב','עשן','נחמה','ניצוץ','חנית','מראה','כדור','שושן',
  'עמוד שדרה','ספירלה','רסיס','נבג','כוכב','גבעול','אבן','סערה','גדיל','גל',
  'קמע','דמעה','מקדש','קרן','מרפסת','חוט','כס','גאות','אסימון','משמר',
