...
export const FEATURE_DETAILS: Record<string, FeatureDetail> = {
  'aurora-ai': {
    ...
    tier: 'free',
    overviewEn: [
      'AION is not another chatbot. She\'s a full-spectrum AI life strategist that learns your behavioral patterns, emotional states, energy cycles, and personal goals — then synthesizes them into real-time coaching guidance.',
      'Unlike generic AI assistants, AION maintains deep contextual memory across every conversation. She remembers your commitments, tracks your follow-through, and adapts her tone, approach, and recommendations based on where you are in your transformation journey.',
      'AION operates across every pillar of your life — from vitality and focus to wealth and relationships — acting as a unified intelligence layer that connects the dots between domains you\'d normally manage in isolation.',
    ],
    overviewHe: [
      'AION היא לא עוד צ\'אטבוט. היא אסטרטגית חיים AI מלאה שלומדת את הדפוסים ההתנהגותיים שלך, מצבים רגשיים, מחזורי אנרגיה ומטרות אישיות — ואז מסנתזת אותם להנחיות אימון בזמן אמת.',
      'בניגוד לעוזרות AI גנריות, AION שומרת זיכרון הקשרי עמוק לאורך כל שיחה. היא זוכרת את ההתחייבויות שלך, עוקבת אחרי המעקב שלך, ומתאימה את הטון, הגישה וההמלצות שלה בהתאם למקום שלך במסע הטרנספורמציה.',
      'AION פועלת לאורך כל עמודי החיים שלך — מחיוניות ומיקוד ועד עושר ומערכות יחסים — ומשמשת כשכבת אינטליגנציה אחודה שמחברת בין תחומים שבדרך כלל היית מנהל בבידוד.',
    ],
    benefitsEn: [
      { title: 'Deep Memory', desc: 'AION remembers every conversation, commitment, and behavioral pattern — building a comprehensive model of who you are and where you\'re headed.' },
      ...
      { title: 'Real-Time Strategy', desc: 'Every interaction generates actionable next steps, not just feel-good affirmations. AION pushes you toward execution.' },
      { title: 'Voice & Text', desc: 'Speak or type — AION processes both, making coaching accessible whether you\'re at your desk or on the move.' },
    ],
    benefitsHe: [
      { title: 'זיכרון עמוק', desc: 'AION זוכרת כל שיחה, התחייבות ודפוס התנהגותי — בונה מודל מקיף של מי שאתה ולאן אתה הולך.' },
      ...
      { title: 'אסטרטגיה בזמן אמת', desc: 'כל אינטראקציה מייצרת צעדים הבאים ברי-ביצוע, לא רק אישורים חיוביים. AION דוחפת אותך לביצוע.' },
      { title: 'קול וטקסט', desc: 'דבר או הקלד — AION מעבדת את שניהם, מה שהופך את האימון לנגיש בין אם אתה ליד המחשב או בדרכים.' },
    ],
    howItWorksEn: [
      { step: 'Onboarding Deep-Dive', desc: 'AION begins with a comprehensive assessment of your life across 11 domains, collecting 70+ behavioral signals to build your initial profile.' },
      { step: 'Context Building', desc: 'Every interaction enriches your profile — AION tracks your energy patterns, emotional states, completed tasks, and behavioral trends.' },
      { step: 'Strategic Guidance', desc: 'Based on your evolving profile, AION generates personalized daily strategies, identifies blind spots, and recalibrates your 90-day plan.' },
      { step: 'Proactive Interventions', desc: 'AION doesn\'t wait for you to ask. She initiates check-ins, sends accountability nudges, and alerts you when patterns suggest you\'re drifting.' },
    ],
    howItWorksHe: [
      { step: 'צלילה עמוקה באונבורדינג', desc: 'AION מתחילה בהערכה מקיפה של החיים שלך ב-11 תחומים, אוספת 70+ אותות התנהגותיים כדי לבנות את הפרופיל הראשוני שלך.' },
      { step: 'בניית הקשר', desc: 'כל אינטראקציה מעשירה את הפרופיל שלך — AION עוקבת אחרי דפוסי האנרגיה, מצבים רגשיים, משימות שהושלמו ומגמות התנהגותיות.' },
      { step: 'הנחיה אסטרטגית', desc: 'על סמך הפרופיל המתפתח שלך, AION מייצרת אסטרטגיות יומיות מותאמות אישית, מזהה נקודות עיוורון ומכילה מחדש את תוכנית 90 הימים שלך.' },
      { step: 'התערבויות יזומות', desc: 'AION לא מחכה שתשאל. היא יוזמת צ\'ק-אינים, שולחת דחיפות אחריותיות ומתריעה כשדפוסים מצביעים על כך שאתה סוטה מהמסלול.' },
    ],
    whoForEn: [
  ...
  'life-os-core': {
    ...
    overviewEn: [
      ...
      'Each pillar operates as an independent assessment and coaching engine. When you enter a domain, AION conducts a deep-dive evaluation — analyzing your current state, identifying gaps, and generating a personalized development plan.',
      'The power isn\'t in any single pillar. It\'s in the system. When all 6 Core pillars are assessed and active, AION generates a Pillar Synthesis — a unified strategy that connects your physical energy to your mental clarity, your identity to your cognitive growth.',
    ],
    overviewHe: [
      ...
      'כל עמוד פועל כמנוע הערכה ואימון עצמאי. כשאתה נכנס לתחום, AION עורכת הערכה מעמיקה — מנתחת את המצב הנוכחי שלך, מזהה פערים ומייצרת תוכנית פיתוח מותאמת אישית.',
      'הכוח לא בעמוד בודד. הוא במערכת. כשכל 6 עמודי ה-Core מוערכים ופעילים, AION מייצרת סינתזת עמודים — אסטרטגיה אחודה שמחברת את האנרגיה הפיזית שלך לבהירות המנטלית, את הזהות שלך לצמיחה הקוגניטיבית.',
    ],
    benefitsEn: [
      ...
      { title: 'AI-Powered Assessments', desc: 'AION conducts conversational deep-dives in each domain, generating insights no static questionnaire could produce.' },
    ...
    benefitsHe: [
      ...
      { title: 'הערכות מופעלות AI', desc: 'AION עורכת צלילות עמוקות שיחתיות בכל תחום, מייצרת תובנות ששאלון סטטי לעולם לא יכול לייצר.' },
    ...
    howItWorksEn: [
      ...
      { step: 'Deep Assessment', desc: 'AION conducts a 15-25 minute conversational assessment, exploring your current state, challenges, and aspirations in that domain.' },
      ...
      { step: 'Plan Generation', desc: 'AION generates domain-specific goals, habits, and milestones that feed into your 90-day transformation plan.' },
      { step: 'Synthesis Unlock', desc: 'Once all 6 Core pillars are assessed, AION creates a holistic Pillar Synthesis connecting all domains into one strategy.' },
    ],
    howItWorksHe: [
      { step: 'בחר תחום', desc: 'כנס לכל אחד מ-6 עמודי ה-Core מתוך Life Hub — נוכחות, עוצמה, חיוניות, מיקוד, לחימה או התרחבות.' },
      { step: 'הערכה מעמיקה', desc: 'AION עורכת הערכה שיחתית של 15-25 דקות, חוקרת את המצב הנוכחי, האתגרים והשאיפות שלך בתחום זה.' },
      { step: 'תוצאות ותובנות', desc: 'קבל פירוט מפורט עם ציונים, דפוסים שזוהו, חוזקות ותחומים לפיתוח.' },
      { step: 'יצירת תוכנית', desc: 'AION מייצרת מטרות, הרגלים ואבני דרך ספציפיות לתחום שמזינות את תוכנית הטרנספורמציה ל-90 ימים שלך.' },
      { step: 'פתיחת סינתזה', desc: 'ברגע שכל 6 עמודי ה-Core מוערכים, AION יוצרת סינתזת עמודים הוליסטית שמחברת את כל התחומים לאסטרטגיה אחת.' },
    ],
    whoForEn: [
  ...
  'vitality-engine': {
    ...
    howItWorksEn: [
      { step: 'Vitality Assessment', desc: 'AION conducts a comprehensive evaluation of your sleep, nutrition, exercise, stress, and recovery habits.' },
      ...
      { step: 'Gap Identification', desc: 'AION identifies the specific biological bottlenecks holding back your performance.' },
    ...
    howItWorksHe: [
      { step: 'הערכת חיוניות', desc: 'AION עורכת הערכה מקיפה של הרגלי השינה, התזונה, הפעילות הגופנית, הסטרס וההתאוששות שלך.' },
      { step: 'חישוב מדד', desc: 'הנתונים שלך מסונתזים למדד חיוניות עם תת-ציונים לכל תחום ביולוגי.' },
      { step: 'זיהוי פערים', desc: 'AION מזהה את צווארי הבקבוק הביולוגיים הספציפיים שמעכבים את הביצועים שלך.' },
  ...
  'focus-engine': {
    ...
    howItWorksEn: [
      { step: 'Focus Assessment', desc: 'AION evaluates your current focus capacity, work habits, environment, and distraction vulnerabilities.' },
      ...
      { step: 'Ongoing Optimization', desc: 'AION continuously refines your focus strategy based on your daily execution data.' },
    ],
    howItWorksHe: [
      { step: 'הערכת מיקוד', desc: 'AION מעריכה את יכולת המיקוד הנוכחית שלך, הרגלי עבודה, סביבה ופגיעויות הסחה.' },
      ...
      { step: 'אופטימיזציה שוטפת', desc: 'AION משכללת ברציפות את אסטרטגיית המיקוד שלך על סמך נתוני הביצוע היומיים.' },
    ],
    whoForEn: [
  ...
  'combat-system': {
    ...
    howItWorksEn: [
      { step: 'Combat Assessment', desc: 'AION evaluates your current martial arts experience, training frequency, and skill levels.' },
    ...
    howItWorksHe: [
      { step: 'הערכת לחימה', desc: 'AION מעריכה את ניסיון אמנויות הלחימה הנוכחי שלך, תדירות אימון ורמות מיומנות.' },
  ...
  'expansion-engine': {
    ...
    howItWorksEn: [
      { step: 'Cognitive Assessment', desc: 'AION maps your current intellectual strengths, learning habits, and creative patterns.' },
    ...
    howItWorksHe: [
      { step: 'הערכה קוגניטיבית', desc: 'AION ממפה את החוזקות האינטלקטואליות הנוכחיות, הרגלי הלמידה והדפוסים היצירתיים שלך.' },
  ...
  'arena-hub': {
    ...
    overviewEn: [
      ...
      'Most personal development platforms stop at internal work. AION connects your inner growth to real-world outcomes: building income, expanding your sphere of influence, deepening meaningful relationships, and executing on projects that matter.',
    ...
    overviewHe: [
      ...
      'רוב פלטפורמות הפיתוח האישי עוצרות בעבודה פנימית. AION מחבר את הצמיחה הפנימית שלך לתוצאות בעולם האמיתי: בניית הכנסה, הרחבת מעגל ההשפעה, העמקת מערכות יחסים משמעותיות וביצוע פרויקטים שחשובים.',
    ...
    howItWorksEn: [
      ...
      { step: 'Deep Assessment', desc: 'AION evaluates your current state in the selected domain through conversational analysis.' },
    ...
    howItWorksHe: [
      ...
      { step: 'הערכה מעמיקה', desc: 'AION מעריכה את המצב הנוכחי שלך בתחום הנבחר דרך ניתוח שיחתי.' },
  ...
  '100-day-blueprint': {
    ...
    tier: 'plus',
    overviewEn: [
      'The 100-Day Transformation OS is your strategic life roadmap — an AI-generated plan with 10 phases (A–J) that takes your identity, goals, constraints, and current life state, then synthesizes them into a structured 100-day execution framework.',
      'This isn\'t a generic template. Every milestone, habit, and action item is personalized to your specific situation. AION considers your energy levels, available time, existing commitments, and psychological readiness when building your plan.',
      'The plan is living — it recalibrates as you complete assessments, hit milestones, and evolve. If your priorities shift, AION adjusts. If you stall, she intervenes. The 100-day plan is the spine that connects every other feature in the system.',
    ],
    overviewHe: [
      'מערכת הטרנספורמציה ל-100 יום היא מפת הדרכים האסטרטגית של החיים שלך — תוכנית שנוצרת ב-AI עם 10 פאזות (A–J) שלוקחת את הזהות, המטרות, האילוצים ומצב החיים הנוכחי שלך, ואז מסנתזת אותם למסגרת ביצוע מובנית ל-100 ימים.',
      'זו לא תבנית גנרית. כל אבן דרך, הרגל ופריט פעולה מותאם אישית למצב הספציפי שלך. AION שוקלת את רמות האנרגיה, הזמן הפנוי, ההתחייבויות הקיימות והמוכנות הפסיכולוגית שלך כשהיא בונה את התוכנית.',
      'התוכנית חיה — היא מכילה מחדש ככל שאתה משלים הערכות, מגיע לאבני דרך ומתפתח. אם העדיפויות שלך משתנות, AION מתאימה. אם אתה נתקע, היא מתערבת. תוכנית 100 הימים היא שדרה שמחברת כל פיצ\'ר אחר במערכת.',
    ],
    benefitsEn: [
      ...
      { title: 'Cross-System Integration', desc: 'Your 100-day plan connects to every feature: AION coaching, 15 domain assessments, gamification, and hypnosis sessions.' },
    ],
    benefitsHe: [
      ...
      { title: 'אינטגרציה חוצת-מערכת', desc: 'תוכנית 100 הימים שלך מתחברת לכל פיצ\'ר: אימון AION, הערכות 15 תחומים, גיימיפיקציה וסשני היפנוזה.' },
    ],
    howItWorksEn: [
      { step: 'Identity Assessment', desc: 'AION maps your values, direction, energy, and current life state through the Launchpad onboarding.' },
      { step: 'Plan Generation', desc: 'An AI engine synthesizes 70+ signals into a structured 100-day plan with 10 phases and daily actions.' },
      ...
      { step: 'Phase Recalibration', desc: 'As you complete assessments and hit milestones, AION automatically adjusts your plan to reflect your evolution.' },
    ],
    howItWorksHe: [
      { step: 'הערכת זהות', desc: 'AION ממפה את הערכים, הכיוון, האנרגיה ומצב החיים הנוכחי שלך דרך אונבורדינג ה-Launchpad.' },
      { step: 'יצירת תוכנית', desc: 'מנוע AI מסנתז 70+ אותות לתוכנית מובנית ל-100 ימים עם 10 פאזות ופעולות יומיות.' },
      { step: 'ביצוע יומי', desc: 'כל יום, טאב ה-Today שלך מראה בדיוק מה לעשות — הרגלים לשמר, משימות להשלים ואבני דרך שמתקרבות.' },
      { step: 'כיול מחדש לפי פאזה', desc: 'ככל שאתה משלים הערכות ומגיע לאבני דרך, AION מתאימה אוטומטית את התוכנית שלך כדי לשקף את ההתפתחות.' },
    ],
    whoForEn: [
  ...
  'ai-hypnosis': {
    ...
    overviewEn: [
      ...
      'Each session is generated dynamically based on your current challenges, emotional state, and coaching context. AION identifies the specific subconscious pattern holding you back and creates a custom session to address it.',
    ],
    overviewHe: [
      ...
      'כל סשן נוצר דינמית על סמך האתגרים הנוכחיים, המצב הרגשי וההקשר האימוני שלך. AION מזהה את הדפוס התת-מודע הספציפי שמעכב אותך ויוצרת סשן מותאם כדי לטפל בו.',
    ],
    benefitsEn: [
    ...
    howItWorksEn: [
      { step: 'Pattern Identification', desc: 'AION identifies a specific subconscious pattern blocking your progress through coaching analysis.' },
      ...
      { step: 'Integration', desc: 'Post-session reflection with AION to integrate insights and track subconscious shifts over time.' },
    ],
    howItWorksHe: [
      { step: 'זיהוי דפוס', desc: 'AION מזהה דפוס תת-מודע ספציפי שחוסם את ההתקדמות שלך דרך ניתוח אימוני.' },
      ...
      { step: 'אינטגרציה', desc: 'רפלקציה לאחר הסשן עם AION כדי לשלב תובנות ולעקוב אחרי שינויים תת-מודעים לאורך זמן.' },
    ],
    whoForEn: [
  ...
  'project-engine': {
    ...
    tier: 'apex',
    overviewEn: [
      'The Project & Execution Engine is where strategy meets action. It\'s a premium project management system that maps your projects directly to life pillars, breaks high-level goals into executable tasks, and uses AION to track momentum.',
    ...
    benefitsEn: [
      ...
      { title: 'AI Momentum Tracking', desc: 'AION monitors your project velocity and intervenes when momentum drops or blockers emerge.' },
    ...
    benefitsHe: [
      ...
      { title: 'מעקב מומנטום AI', desc: 'AION עוקבת אחרי מהירות הפרויקט שלך ומתערבת כשהמומנטום יורד או חסימות צצות.' },
    ...
    howItWorksEn: [
      ...
      { step: 'Goal & Task Breakdown', desc: 'AION decomposes your project into structured goals and tasks connected to your 90-day plan.' },
      ...
      { step: 'Momentum Monitoring', desc: 'AION tracks completion rates, flags blockers, and proactively coaches you through execution challenges.' },
    ],
    howItWorksHe: [
      { step: 'אשף פרויקט', desc: 'עבור דרך הגדרה מונחית בת 6 שלבים שלוכדת את חזון הפרויקט, המטרה, העמודים וקריטריוני ההצלחה.' },
      { step: 'פירוק מטרות ומשימות', desc: 'AION מפרקת את הפרויקט שלך למטרות ומשימות מובנות שמחוברות לתוכנית 90 הימים.' },
      { step: 'אינטגרציה יומית', desc: 'משימות פרויקט מופיעות בטאב ה-Today שלך לצד פעולות פיתוח אישי לביצוע אחוד.' },
      { step: 'מעקב מומנטום', desc: 'AION עוקבת אחרי שיעורי השלמה, מסמנת חסימות ומאמנת אותך יזומית דרך אתגרי ביצוע.' },
    ],
    whoForEn: [
  ...
  'proactive-coaching': {
    ...
    tier: 'apex',
    overviewEn: [
      'Proactive Coaching transforms AION from a reactive assistant into a true life operating system. Instead of waiting for you to open the app, AION initiates — sending morning briefings, mid-day check-ins, and accountability prompts based on your schedule and patterns.',
      'This is the difference between having a coach you visit and having a coach who\'s always watching your back. AION knows when you\'re likely to skip a habit, when stress is building before you notice, and when momentum is shifting.',
      'The system is designed for discipline without burnout. AION calibrates intervention frequency based on your responsiveness and energy levels — pushing when you need it, backing off when you need space.',
    ],
    overviewHe: [
      'אימון יזום הופך את AION מעוזרת תגובתית למערכת הפעלה אמיתית לחיים. במקום לחכות שתפתח את האפליקציה, AION יוזמת — שולחת תדרוכי בוקר, צ\'ק-אינים בצהריים ודחיפות אחריותיות בהתאם ללוח הזמנים והדפוסים שלך.',
      'זה ההבדל בין שיש לך מאמן שאתה מבקר לבין שיש לך מאמן שתמיד שומר עליך. AION יודעת מתי סביר שתדלג על הרגל, מתי סטרס מצטבר לפני שאתה שם לב, ומתי המומנטום משתנה.',
      'המערכת מתוכננת למשמעת בלי שחיקה. AION מכילה את תדירות ההתערבות בהתאם לתגובתיות ורמות האנרגיה שלך — דוחפת כשאתה צריך, נסוגת כשאתה צריך מרחב.',
    ],
    benefitsEn: [
      ...
      { title: 'Pattern Detection', desc: 'AION identifies negative patterns forming and intervenes before they become habits.' },
    ...
    benefitsHe: [
      ...
      { title: 'זיהוי דפוסים', desc: 'AION מזהה דפוסים שליליים שמתגבשים ומתערבת לפני שהם הופכים להרגלים.' },
    ...
    howItWorksEn: [
      { step: 'Schedule Learning', desc: 'AION learns your daily patterns, peak times, and when you\'re most receptive to coaching.' },
      ...
      { step: 'Response Calibration', desc: 'Based on how you respond to nudges, AION adjusts frequency and intensity for maximum impact without fatigue.' },
    ],
    howItWorksHe: [
      { step: 'למידת לוח זמנים', desc: 'AION לומדת את הדפוסים היומיים שלך, זמני שיא, ומתי אתה הכי קולט לאימון.' },
      ...
      { step: 'כיול תגובה', desc: 'על סמך איך אתה מגיב לדחיפות, AION מתאימה תדירות ועוצמה להשפעה מרבית בלי עייפות.' },
    ],
    whoForEn: [
  ...
  'play-system': {
    ...
    overviewEn: [
      ...
      'AION monitors your play patterns, notices gaps, suggests new categories to explore, and connects your play activity to measurable improvements in energy, focus, and overall performance. The result is a balanced Arena where execution includes restoration.',
    ],
    overviewHe: [
      ...
      'AION עוקבת אחרי דפוסי ה-Play שלך, מזהה פערים, מציעה קטגוריות חדשות לחקור ומחברת את פעילות ה-Play שלך לשיפורים מדידים באנרגיה, מיקוד וביצועים כוללים. התוצאה היא זירה מאוזנת שבה ביצוע כולל התחדשות.',
    ],
    benefitsEn: [
      ...
      { title: 'Gap Detection', desc: 'AION notices when you haven\'t played in too long and proactively suggests sessions based on your schedule.' },
    ...
    benefitsHe: [
      ...
      { title: 'זיהוי פערים', desc: 'AION מזהה כשלא שיחקת יותר מדי זמן ומציעה יזומות סשנים בהתאם ללוח הזמנים שלך.' },
    ...
    howItWorksEn: [
      ...
      { step: 'Reflect & Learn', desc: 'After completion, AION asks 3 short reflection prompts about flow, body response, and frequency — building your Play intelligence.' },
    ...
    howItWorksHe: [
      ...
      { step: 'הרהר ולמד', desc: 'לאחר השלמה, AION שואלת 3 שאלות רפלקציה קצרות על flow, תגובת הגוף ותדירות — ובונה את אינטליגנציית ה-Play שלך.' },
