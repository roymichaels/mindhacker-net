...
export const FEATURE_DETAILS: Record<string, FeatureDetail> = {
  ...
  '100-day-blueprint': {
    ...
    overviewEn: [
      ...
      'The plan is living — it recalibrates as you complete assessments, hit milestones, and evolve. If your priorities shift, Aurora adjusts. If you stall, she intervenes. The 100-day plan is the spine that connects every other feature in the system.',
    ],
    overviewHe: [
      ...
      'התוכנית חיה — היא מכילה מחדש ככל שאתה משלים הערכות, מגיע לאבני דרך ומתפתח. אם העדיפויות שלך משתנות, Aurora מתאימה. אם אתה נתקע, היא מתערבת. תוכנית 100 הימים היא שדרה שמחברת כל פיצ\'ר אחר במערכת.',
    ],
    benefitsEn: [
    ...
    howItWorksEn: [
      ...
      { step: 'Phase Recalibration', desc: 'As you complete assessments and hit milestones, Aurora automatically adjusts your plan to reflect your evolution.' },
    ],
    howItWorksHe: [
      ...
      { step: 'כיול מחדש לפי פאזה', desc: 'ככל שאתה משלים הערכות ומגיע לאבני דרך, Aurora מתאימה אוטומטית את התוכנית שלך כדי לשקף את ההתפתחות.' },
    ],
    whoForEn: [
