...
export const FEATURE_DETAILS: Record<string, FeatureDetail> = {
  ...
  'life-protocol-compiler': {
    ...
    overviewEn: [
      'The Life Protocol Compiler transforms your daily existence from a series of improvised decisions into a precision-engineered execution schedule. This is not a to-do list. This is not a motivational roadmap. This is a time-locked command schedule that removes negotiation from your day.',
      'You input your wake time, sleep time, energy peaks, crash windows, training blocks, and work hours. The system compiles a structured daily blueprint where every waking minute has a purpose. Deep work aligns with energy peaks. Training never conflicts with recovery debt. Focus blocks are protected. Recovery overrides intensity when needed.',
      'Once you commit, the protocol locks for 7 days. No edits. No renegotiation. You wake up and follow. Compliance is tracked per block, per day, with a visible percentage that holds you accountable. This is the architecture that separates people who plan from people who execute.',
    ],
    overviewHe: [
      'מהדר פרוטוקול החיים הופך את הקיום היומי שלך מסדרת החלטות אימפרוביזציות ללוח זמנים ביצוע מהונדס בדיוק. זו לא רשימת משימות. זו לא מפת דרכים מוטיבציונית. זה לוח פיקוד נעול בזמן שמסיר משא ומתן מהיום שלך.',
      'אתה מזין שעת השכמה, שעת שינה, שיאי אנרגיה, חלונות קריסה, בלוקי אימון ושעות עבודה. המערכת מהדרת תוכנית יומית מובנית שבה לכל דקת ערות יש מטרה. עבודה עמוקה מיושרת עם שיאי אנרגיה. אימון לעולם לא מתנגש עם חוב ריקברי.',
      'ברגע שאתה מתחייב, הפרוטוקול ננעל ל-7 ימים. ללא עריכות. ללא מו"מ מחדש. אתה קם ומבצע. ציות נעקב לפי בלוק, לפי יום, עם אחוז גלוי שמחזיק אותך אחראי.',
    ],
    benefitsEn: [
      { title: 'Zero-Decision Mornings', desc: 'Wake up to a pre-compiled schedule. No thinking about what comes next — just execute.' },
      { title: 'Energy-Aligned Blocks', desc: 'Deep work during peak energy. Recovery during crash windows. Training at optimal times.' },
      { title: '7-Day Lock Commitment', desc: 'Once confirmed, the schedule is immutable for 7 days. This eliminates negotiation and builds iron discipline.' },
      { title: 'Compliance Tracking', desc: 'Every block is tracked. Daily compliance percentage visible. No hiding from execution gaps.' },
      { title: 'Tier-Based Intelligence', desc: 'Free users get anchor blocks. Plus users get full blueprints with weekly recalibration. Apex users get adaptive micro-adjustments.' },
      { title: 'Recovery Protection', desc: 'The compiler prevents overbooking and ensures recovery buffers are maintained even under high-intensity schedules.' },
    ],
    benefitsHe: [
      { title: 'בקרים ללא החלטות', desc: 'התעורר ללוח זמנים מהודר מראש. ללא מחשבה על מה בא הלאה — פשוט בצע.' },
      { title: 'בלוקים מיושרי אנרגיה', desc: 'עבודה עמוקה בשיא אנרגיה. ריקברי בחלונות קריסה. אימון בזמנים אופטימליים.' },
      { title: 'נעילת התחייבות 7 ימים', desc: 'לאחר אישור, לוח הזמנים בלתי ניתן לשינוי למשך 7 ימים. זה מבטל משא ומתן ובונה משמעת ברזל.' },
      { title: 'מעקב ציות', desc: 'כל בלוק נעקב. אחוז ציות יומי גלוי. אין מקום להסתתר מפערי ביצוע.' },
      { title: 'אינטליגנציה מבוססת שכבות', desc: 'משתמשי חינם מקבלים בלוקי עוגן. Plus מקבלים תוכניות מלאות עם כיול שבועי. Apex מקבלים התאמות מיקרו אדפטיביות.' },
      { title: 'הגנת ריקברי', desc: 'המהדר מונע הזמנת יתר ומבטיח שמאגרי ריקברי נשמרים גם תחת לוחות זמנים בעצימות גבוהה.' },
    ],
    howItWorksEn: [
      { step: 'Define Time Architecture', desc: 'Input wake time, sleep time, energy peaks, crash windows, training and work hours.' },
      { step: 'Compile Protocol', desc: 'The engine generates a structured daily blueprint with typed blocks: focus, training, recovery, work, reflection, play.' },
      { step: 'Commit & Lock', desc: 'Review the schedule and confirm. Protocol locks for 7 days. No modifications allowed.' },
      { step: 'Execute & Track', desc: 'Each block shows in a timeline. Mark complete or skip. Compliance percentage updates in real-time.' },
      { step: 'Recalibrate Weekly', desc: 'After 7 days, review compliance data and adjust parameters. Recompile for the next cycle.' },
    ],
    howItWorksHe: [
      { step: 'הגדר ארכיטקטורת זמן', desc: 'הזן שעת השכמה, שעת שינה, שיאי אנרגיה, חלונות קריסה, שעות אימון ועבודה.' },
      { step: 'הדר פרוטוקול', desc: 'המנוע מייצר תוכנית יומית מובנית עם בלוקים מסוגים: מיקוד, אימון, ריקברי, עבודה, רפלקציה, משחק.' },
      { step: 'התחייב ונעל', desc: 'עבור על לוח הזמנים ואשר. הפרוטוקול ננעל ל-7 ימים. ללא שינויים מותרים.' },
      { step: 'בצע ועקוב', desc: 'כל בלוק מוצג בציר זמן. סמן כהושלם או דלג. אחוז ציות מתעדכן בזמן אמת.' },
      { step: 'כיול שבועי', desc: 'אחרי 7 ימים, סקור נתוני ציות והתאם פרמטרים. הדר מחדש למחזור הבא.' },
    ],
    whoForEn: [
      'Operators who want zero-negotiation mornings and a pre-compiled day',
      'High-performers who know what to do but struggle with when to do it',
      'Anyone tired of planning systems that lack time-locked accountability',
    ],
    whoForHe: [
      'מפעילים שרוצים בקרים ללא משא ומתן ויום מהודר מראש',
      'אנשי ביצועים גבוהים שיודעים מה לעשות אבל מתקשים עם מתי לעשות את זה',
      'כל מי שעייף ממערכות תכנון שחסרות אחריותיות נעולת זמן',
    ],
    tier: 'plus',
  },
};
