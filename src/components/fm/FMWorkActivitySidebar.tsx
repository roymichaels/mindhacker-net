...
export function FMWorkActivitySidebar() {
  ...
  return (
    <aside className={cn(
      ...
      collapsed ? "w-16 min-w-[64px]" : "w-full md:w-[260px] md:min-w-[200px] xl:w-[280px] fixed md:relative left-0 md:left-auto top-14 bottom-0 z-[55] md:z-auto md:top-auto bg-background md:bg-transparent"
    )}>
      <button
