  ...
  return (
    <AnimatePresence mode="wait">
      <motion.div
        ...
        className="relative overflow-hidden bg-card border border-border rounded-xl p-2.5"
      >
        {/* Subtle gradient */}
        ...
        <div className="relative space-y-1.5">
          <div className="flex items-center gap-2.5">
            <div className="w-7 h-7 rounded-lg bg-accent/15 flex items-center justify-center shrink-0 text-sm">
              {displayed.icon}
            </div>
            ...
            {displayed.reward > 0 && (
              <div className="flex items-center gap-1 shrink-0 bg-accent/10 px-1.5 py-0.5 rounded-full">
                <Coins className="w-2.5 h-2.5 text-accent" />
                <span className="text-[10px] font-bold text-accent">{displayed.reward}</span>
              </div>
            )}
          </div>
