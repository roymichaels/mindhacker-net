...
const MILESTONES: Milestone[] = [
  ...
  { id: 'earn_100', titleEn: 'Earn 100 MOS', titleHe: 'הרוויח 100 MOS', hintEn: 'Keep earning to reach 100', hintHe: 'המשך להרוויח עד 100', action: 'navigate', navTarget: '/fm', rewardMos: 25 },
