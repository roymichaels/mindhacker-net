...
const tiers = [
  {
    ...
    featuresEn: ['2 of 15 life pillars', '5 AION messages/day', 'Full assessment', 'Dashboard & daily structure'],
  },
  {
    id: 'plus',
    icon: Zap,
    ...
    featuresEn: ['6 of 15 life pillars', 'Unlimited AION + memory', '100-Day Transformation Plan', 'AI Hypnosis + execution engine'],
  },
  {
    id: 'apex',
    icon: Crown,
    ...
    featuresEn: ['All 15 pillars unlocked', 'Proactive AION engine', 'Projects + Business Advanced', 'Full AION profile'],
  },
];
