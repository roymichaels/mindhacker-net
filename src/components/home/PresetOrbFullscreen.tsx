...
interface PresetOrbFullscreenProps {
  open: boolean;
  onClose: () => void;
  profile: OrbProfile | null;
}

export function PresetOrbFullscreen({ open, onClose, profile }: PresetOrbFullscreenProps) {
        ...
        >
          ...
          <motion.button
            style={{
              ...
              padding: 10, borderRadius: '50%', background: 'rgba(255,255,255,0.1)',
