/**
 * AuroraCoachSection - Simplified: HoloOrb + 2x2 feature grid, no chat preview
 */
import { motion } from 'framer-motion';
import { Bot, Mic, Brain, Headphones } from 'lucide-react';
        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
              ...
              <span className="text-sm font-medium text-primary">{t('home.auroraCoach.badge')}</span>
            </div>

            <h2 className="text-3xl sm:text-4xl font-bold">{t('home.auroraCoach.title')}</h2>
