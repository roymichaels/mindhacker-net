 ...
 * Shows all 14 life domains with icons and descriptions
 */
      ...
      <div className="container mx-auto max-w-6xl" dir={isRTL ? 'rtl' : 'ltr'}>
        ...
        >
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            {isRTL
              ? '14 תחומים. שני עולמות. מערכת אחת שמחברת את הכל.'
              : '14 domains. Two worlds. One system that connects it all.'}
          </p>
        </motion.div>
