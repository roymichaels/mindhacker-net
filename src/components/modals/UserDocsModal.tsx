      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Aurora Chat Dock', titleHe: 'דוק הצ\'אט של אורורה',
            description: 'Your AION at the bottom-left opens the Aurora chat dock. It slides up for quick conversations. You can expand it to full screen or minimize it.',
    ...
    cards: [
      {
        ...
        steps: [
          { title: 'Open a Conversation', titleHe: 'פתח שיחה',
            description: 'Click your AION presence or the chat icon. MindOS remembers your previous conversations, your life plan, current mood, and active goals. It picks up right where you left off.',
