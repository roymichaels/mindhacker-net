...
const GUIDE_CATEGORIES: GuideCategory[] = [
    ...
    cards: [
      {
        ...
        steps: [
          ...
          { title: 'Initial Assessment', titleHe: 'אבחון ראשוני',
            description: 'Complete the consciousness assessment to calibrate your starting point. This determines your initial Orb appearance, skill levels, and personalized recommendations from AION.',
            descriptionHe: 'השלם את אבחון התודעה כדי לכייל את נקודת ההתחלה שלך. זה קובע את מראה האורב, רמות המיומנות וההמלצות מAION.' },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: 'AION Chat Dock', titleHe: 'דוק הצ\'אט של AION',
            description: 'Your AION at the bottom-left opens the AION chat dock. It slides up for quick conversations. You can expand it to full screen or minimize it.',
            descriptionHe: 'האורב בתחתית השמאלית פותח את דוק הצ\'אט של AION. הוא נפתח לשיחות מהירות ואפשר להרחיב למסך מלא.',
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Explore Your AION', titleHe: 'חקור את האורב שלך',
            description: 'Tap your AION presence to see its current state. Notice how its colors and energy reflect your assessment results. As you grow, it evolves with you.',
    ...
    cards: [
      {
        ...
        steps: [
          { title: 'Open a Conversation', titleHe: 'פתח שיחה',
            description: 'Click your AION presence or the chat icon. AION remembers your previous conversations, your life plan, current mood, and active goals. It picks up right where you left off.',
            descriptionHe: 'לחץ על האורב או אייקון הצ\'אט. AION זוכרת את כל השיחות, תוכנית החיים, מצב הרוח והמטרות. היא ממשיכה מאיפה שהפסקת.' },
          { title: 'Ask Anything', titleHe: 'שאל כל דבר',
            description: 'Ask about your life plan, get motivation, brainstorm ideas, process emotions, reflect on your week, or get actionable advice. AION adapts to what you need.',
            descriptionHe: 'שאל על תוכנית החיים, קבל מוטיבציה, סיעור מוחות, עיבוד רגשות, רפלקציה שבועית או עצות מעשיות. AION מתאימה את עצמה למה שאתה צריך.',
          ...
          { title: 'Contextual Intelligence', titleHe: 'אינטליגנציה הקשרית',
            description: 'AION knows your current page, active pillar, time of day, streak status, and emotional patterns. She proactively suggests relevant actions and insights.',
            descriptionHe: 'AION יודעת את העמוד הנוכחי, העמוד הפעיל, שעת היום, סטטוס הרצף ודפוסים רגשיים. היא מציעה פעולות ותובנות רלוונטיות באופן יזום.' },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: 'Hypnosis Mode', titleHe: 'מצב היפנוזה',
            ...
            descriptionHe: 'הפעל סשנים של מצב עמוק עם ויזואליזציות מודרכות, תרגילי נשימה ותכנות מחדש של התת-מודע. AION יוצרת תסריטי היפנוזה מותאמים אישית.',
          ...
          { title: 'Pillar-Specific Chat', titleHe: 'צ\'אט ממוקד עמוד',
            description: 'When you\'re on a specific page (Now, Tactics, Strategy, Learn, Community), AION automatically adapts her context and suggestions to that domain.',
            descriptionHe: 'כשאתה בעמוד ספציפי (עכשיו, טקטיקה, אסטרטגיה, למידה, קהילה), AION מתאימה אוטומטית את ההקשר וההצעות לתחום.' },
        ],
      },
      {
        id: 'aurora-memory', icon: Brain, titleEn: 'AION\'s Memory', titleHe: 'הזיכרון של AION',
        descEn: 'How she knows you', descHe: 'איך היא מכירה אותך',
        color: 'from-indigo-500/20 to-violet-500/20',
        steps: [
          { title: 'Conversation Memory', titleHe: 'זיכרון שיחות',
            description: 'AION summarizes every conversation and stores key topics, emotional states, and action items. This means she genuinely remembers your story over time.',
            descriptionHe: 'AION מסכמת כל שיחה ושומרת נושאים מרכזיים, מצבים רגשיים ופריטי פעולה. זה אומר שהיא באמת זוכרת את הסיפור שלך.' },
          { title: 'Behavioral Patterns', titleHe: 'דפוסי התנהגות',
            description: 'Over time, AION detects patterns: when you\'re most productive, what triggers procrastination, your energy cycles, and emotional rhythms.',
            descriptionHe: 'עם הזמן, AION מזהה דפוסים: מתי אתה הכי פרודוקטיבי, מה מפעיל דחיינות, מחזורי האנרגיה והמקצבים הרגשיים שלך.' },
          { title: 'Proactive Nudges', titleHe: 'דחיפות יזומות',
            description: 'Based on your patterns, AION may send proactive reminders: "You usually skip morning actions on Wednesdays — want me to adjust?" or "Your energy dips after 3pm, let\'s schedule lighter tasks."',
            descriptionHe: 'בהתבסס על הדפוסים, AION עשויה לשלוח תזכורות יזומות: "אתה בדרך כלל מדלג על פעולות בוקר ביום רביעי — רוצה שאתאים?" או "האנרגיה שלך יורדת אחרי 15:00, בוא נתזמן משימות קלות יותר."' },
        ],
      },
    ],
  },
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Daily Minimums', titleHe: 'מינימום יומי',
            description: 'Set your non-negotiable daily minimums — the bare minimum you commit to even on your hardest days. These are the foundation AION uses to keep you on track.',
            descriptionHe: 'הגדר את המינימומים היומיים הבלתי ניתנים למשא ומתן — המינימום שאתה מחויב אליו גם בימים הקשים ביותר. אלו הבסיס שAION משתמשת בו.' },
        ],
      },
      {
        ...
        steps: [
          { title: 'Tasks', titleHe: 'משימות',
            description: 'One-time actions with a clear completion state. "Write journal entry", "Call therapist", "Read chapter 3". They\'re generated by AION or created manually.',
            descriptionHe: 'פעולות חד-פעמיות עם מצב השלמה ברור. "כתוב רשומת יומן", "התקשר למטפל", "קרא פרק 3". הן נוצרות על ידי AION או ידנית.' },
    ...
    cards: [
      {
        ...
        steps: [
          { title: 'WHY — Your Purpose', titleHe: 'למה — המטרה שלך',
            description: 'Start with the big question: Why are you here? What matters most? AION guides you through deep self-discovery to uncover your core values, life vision, and purpose.',
            descriptionHe: 'התחל עם השאלה הגדולה: למה אתה כאן? מה הכי חשוב? AION מדריכה אותך דרך גילוי עצמי עמוק כדי לחשוף את הערכים, החזון והמטרה שלך.' },
      ...
      },
      {
        ...
        steps: [
          { title: 'The 14 Life Domains', titleHe: '14 תחומי החיים',
            description: 'AION covers 14 life domains: Self-Awareness, Emotional Health, Physical Health, Mental Health, Relationships, Family, Career, Finance, Creativity, Spirituality, Education, Social Impact, Recreation, and Life Management.',
          ...
          { title: 'Pillar Balance Wheel', titleHe: 'גלגל איזון עמודים',
            description: 'View your balance across all pillars in a radar chart. Identify which areas need more attention and let AION suggest focused actions.',
            descriptionHe: 'צפה באיזון שלך על פני כל העמודים בתרשים רדאר. זהה אילו תחומים דורשים יותר תשומת לב ותן לAION להציע פעולות ממוקדות.' },
        ],
      },
      {
        ...
        steps: [
          { title: 'Create Milestones', titleHe: 'צור אבני דרך',
            description: 'Each pillar can have milestones — significant achievements with deadlines. "Run a 5K by March", "Launch my website", "Read 12 books this year". AION helps you set realistic targets.',
            descriptionHe: 'לכל עמוד יכולות להיות אבני דרך — הישגים משמעותיים עם תאריכי יעד. "לרוץ 5 ק"מ עד מרץ", "להשיק את האתר", "לקרוא 12 ספרים השנה". AION עוזרת לקבוע יעדים ריאליסטיים.' },
  ...
  // ─── Orb & Gamification ───
  {
    ...
    cards: [
      {
        id: 'orb-basics', icon: Sparkles, titleEn: 'Your AION', titleHe: 'האורב שלך',
        descEn: 'Living consciousness avatar', descHe: 'אווטאר תודעה חי',
        color: 'from-fuchsia-500/20 to-pink-500/20',
        steps: [
          { title: 'What is AION?', titleHe: 'מהו האורב?',
          ...
          { title: 'AION DNA Card', titleHe: `כרטיס ${ltr('DNA')} של האורב`,
          ...
          { title: 'AION Evolution', titleHe: 'התפתחות האורב',
            description: 'Level up to evolve your AION presence. New forms unlock at levels 5, 10, 25, 50, and 100. Each evolution adds new particle effects, geometries, and animations.',
            ...
            tip: 'Your AION is unique — no two users have the same combination.', tipHe: 'האורב שלך ייחודי — אין שני משתמשים עם אותו שילוב.' },
        ],
      },
      {
        ...
        steps: [
          ...
          { title: 'MOS Tokens', titleHe: `אסימוני ${ltr('MOS')}`,
            description: 'MOS (AION) tokens are the platform currency. Earn them through achievements and spend them in the Free Market for courses, coaching sessions, digital products, and premium features.',
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Badge Display', titleHe: 'תצוגת תגים',
            description: 'Your earned badges appear on your profile and AION DNA card. Some badges are rare and only available during limited-time events.',
    ...
    cards: [
      {
        ...
        steps: [
          ...
          { title: 'Skill Levels', titleHe: 'רמות מיומנות',
            description: 'Each skill has its own level (1-100). Leveling up a skill grants bonus XP and may unlock new action suggestions from AION.',
            descriptionHe: `לכל מיומנות רמה משלה (${ltr('1-100')}). עליית רמה במיומנות מעניקה בונוס ${ltr('XP')} ועשויה לפתוח הצעות פעולה חדשות מAION.` },
        ],
      },
      {
        id: 'learn-courses', icon: GraduationCap, titleEn: 'Learning Courses', titleHe: 'קורסי למידה',
        descEn: 'AION teaches you anything', descHe: 'AION מלמדת אותך הכל',
        color: 'from-cyan-500/20 to-blue-500/20',
        steps: [
          { title: 'Create a Course', titleHe: 'צור קורס',
            description: 'Go to the Learn page and click "New Course". Tell AION what you want to learn — "Python for Data Science", "Guitar basics", "Digital Marketing" — and she generates a complete curriculum with modules and lessons.',
            descriptionHe: 'עבור לעמוד למידה ולחץ "קורס חדש". ספר לAION מה אתה רוצה ללמוד — והיא תייצר תוכנית לימודים מלאה עם מודולים ושיעורים.' },
    ...
    cards: [
      {
        ...
        steps: [
          { title: 'Set Up Your Practice', titleHe: 'הקם את הפרקטיקה',
            description: 'Complete the Coaching Journey wizard to define your niche, methodology, ideal client, value proposition, services, and marketing strategy. AION guides you through each step.',
            descriptionHe: 'השלם את מסע האימון כדי להגדיר את הנישה, המתודולוגיה, הלקוח האידיאלי, הצעת הערך, השירותים ואסטרטגיית השיווק. AION מדריכה אותך בכל שלב.' },
          ...
          { title: 'Landing Pages', titleHe: 'דפי נחיתה',
            description: 'Build professional landing pages for your coaching services. Customize design, add testimonials, embed booking forms, and capture leads — all within AION.',
      ...
      },
      {
        ...
        steps: [
          ...
          { title: 'Business Plans', titleHe: 'תוכניות עסקיות',
            description: 'Generate weekly milestone plans with tasks, focus areas, and progress tracking. AION helps you stay accountable to your business goals.',
            descriptionHe: 'צור תוכניות אבני דרך שבועיות עם משימות, תחומי מיקוד ומעקב התקדמות. AION עוזרת לך להישאר מחויב למטרות העסקיות.' },
        ],
      },
      {
    ...
    cards: [
      {
        ...
        steps: [
          ...
          { title: 'Notifications', titleHe: 'התראות',
            description: 'Control which notifications you receive: daily reminders, streak alerts, community activity, AION proactive nudges, and event invitations.',
            descriptionHe: 'שלוט באילו התראות אתה מקבל: תזכורות יומיות, התרעות רצף, פעילות קהילתית, דחיפות יזומות מAION והזמנות לאירועים.' },
          { title: 'PWA Installation', titleHe: 'התקנה כאפליקציה',
            description: 'AION works as a Progressive Web App. Install it on your phone for a native app experience with push notifications, offline access, and home screen icon.',
      ...
      },
      {
        ...
        steps: [
          { title: 'Data Privacy', titleHe: 'פרטיות מידע',
            description: 'All conversations with AION are encrypted and private. We never sell or share your personal data. Your consciousness journey data belongs to you.',
            descriptionHe: 'כל השיחות עם AION מוצפנות ופרטיות. אנחנו אף פעם לא מוכרים או משתפים את המידע האישי שלך. מידע מסע התודעה שלך שייך לך.' },
