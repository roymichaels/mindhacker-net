...
interface PractitionerMiniItemCardProps {
  item: MiniItemCardData;
  onClick?: () => void;
}

const PractitionerMiniItemCard = ({ item, onClick }: PractitionerMiniItemCardProps) => {
...
export default PractitionerMiniItemCard;
