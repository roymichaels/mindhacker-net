    ...
    <>
      ...
      >
        <div className="grid grid-cols-[auto_1fr_auto] items-center gap-2 px-3 py-2 max-w-screen-xl mx-auto">
          ...
          >
            <div className="flex-shrink-0 rounded-xl overflow-visible transition-shadow duration-700" style={{ width: 44, height: 44, ...orbGlowStyle }}>
              <PersonalizedOrb size={80} state={movementScore >= 80 ? 'speaking' : 'idle'} renderer="css" />
            </div>
            {identityTitle && (
