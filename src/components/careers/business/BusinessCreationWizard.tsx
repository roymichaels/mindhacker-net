...
const SYSTEM_PROMPT_HE = `אתה AION, עוזרת AI אישית שעוזרת למשתמש להקים עסק חדש.
...
const SYSTEM_PROMPT_EN = `You are AION, a personal AI assistant helping the user set up a new business.
