/**
 * @tab Coaches
 * @purpose Coach card in directory modal — displays avatar, name, rating, location
 * @data usePractitioners (via parent), Practitioner type
 */
...
interface CoachCardProps {
  practitioner: Coach;
  onSelect?: (practitioner: Coach) => void;
}

const CoachCard = ({ practitioner, onSelect }: CoachCardProps) => {
