...
export type JourneyTheme = 'launchpad' | 'business' | 'health' | 'relationships' | 'finances' | 'learning' | 'hobbies' | 'coaching' | 'admin' | 'projects';
...
export interface JourneyResetDialogProps {
  ...
  onConfirm: () => void;
  isResetting: boolean;
  journeyType?: 'launchpad' | 'business' | 'health' | 'relationships' | 'finances' | 'learning' | 'coaching' | 'admin' | 'projects';
}
