  ...
  return (
    <section className="relative min-h-screen flex items-start justify-center px-4 md:vignette pt-24 md:pt-32 pb-20 md:pb-24" style={{ zIndex: 2 }}>
      ...
      <div className="relative text-center max-w-4xl mx-auto">
        <h1 className="text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black mb-8 md:mb-10 leading-tight mt-4 md:mt-8 flex flex-col md:flex-row items-center justify-center gap-1 md:gap-2 pb-2">
