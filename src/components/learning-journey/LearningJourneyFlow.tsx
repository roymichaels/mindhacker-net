...
interface LearningJourneyFlowProps {
  journeyId?: string;
  onComplete?: () => void;
  onClose?: () => void;
}

const LearningJourneyFlow = ({ journeyId, onComplete, onClose }: LearningJourneyFlowProps) => {
  ...
  const renderStep = () => {
    ...
    switch (activeStep) {
      ...
      case 2: return <LearningStyleStep {...stepProps} />;
      case 3: return <SkillsStep {...stepProps} />;
      case 4: return <ReadingStep {...stepProps} />;
      case 5: return <CoursesStep {...stepProps} />;
      case 6: return <PracticeStep {...stepProps} />;
        ...
        >
          <div className="flex items-center justify-between mb-4">
            ...
            <Button
              ...
              size="icon"
              onClick={handleClose}
              className="text-muted-foreground hover:text-indigo-400 hover:bg-indigo-900/30"
            >
              <X className="h-5 w-5" />
            </Button>
          </div>
...
export default LearningJourneyFlow;
