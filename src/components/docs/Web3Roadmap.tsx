...
const phases: RoadmapPhase[] = [
  {
    ...
    items: [
      ...
      { he: 'מכניזם Grow2Earn', en: 'Grow2Earn Mechanism' },
      { he: 'מכניזם Data2Earn', en: 'Data2Earn Mechanism' },
      { he: 'מכניזם Work2Earn', en: 'Work2Earn Mechanism' },
      { he: 'מכניזם Learn2Earn', en: 'Learn2Earn Mechanism' },
    ],
  },
  {
    quarter: 'Q2 2026',
