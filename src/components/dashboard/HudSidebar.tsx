  ...
  return (
    <>
      <aside className={cn(
        ...
        {/* ===== COLLAPSED MINI VIEW ===== */}
        {collapsed && (
          <div className="flex flex-col items-center justify-between h-full pt-7 pb-4 px-1 overflow-hidden">
            {/* Top: Orb + Level */}
        ...
        {/* ===== EXPANDED FULL VIEW ===== */}
        {!collapsed && (
        <div className="flex flex-col items-center justify-between p-3 pt-8 pb-4 overflow-hidden h-full">
