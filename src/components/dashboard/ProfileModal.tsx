              ...
              >
                ...
                >
                  {isLaunchpadComplete ? (
                    <>
                      ...
                      {language === 'he' ? 'ערוך את המסע' : 'Edit Journey'}
                    </>
                  ) : (
                    <>
                      <ArrowRight className="w-4 h-4 me-2" />
                      {language === 'he' ? 'המשך את המסע' : 'Continue Journey'}
                    </>
                  )}
                </Button>
                ...
                {isLaunchpadComplete && (
                  ...
                  >
                    ...
                    {language === 'he' ? 'נתח מחדש עם AI' : 'Re-analyze with AI'}
                  </Button>
                )}
              </motion.div>
            </div>
...
function ScoreCard({ 
  ...
  return (
    <div className="relative overflow-hidden rounded-xl bg-card/50 backdrop-blur-sm border border-border/50 p-3 text-center">
      <div className={cn(
      ...
      <div className="relative z-10">
        <div className={cn(
          "inline-flex items-center justify-center w-8 h-8 rounded-lg mb-2 bg-gradient-to-br text-white",
          gradient
        )}>
          {icon}
        </div>
