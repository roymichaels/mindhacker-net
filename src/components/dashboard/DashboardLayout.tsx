  ...
  return (
    <div className="min-h-screen flex bg-background w-full" dir={isRTL ? 'rtl' : 'ltr'}>
      ...
      <div className="flex-1 flex min-h-0">
        ...
        {/* Main Content - pt-16 to clear top notification icons */}
        <main className="flex-1 min-w-0 min-h-0 overflow-hidden p-4 lg:p-6 pt-16 pb-32 flex flex-col bg-sidebar backdrop-blur-sm">
          {children}
        </main>
      </div>
