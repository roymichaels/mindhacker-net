...
import { ChevronLeft, ChevronRight, ArrowRight, X, GripVertical, Globe } from 'lucide-react';
...
const STEP2_KEYS = [
  ...
  'work_type', 'work_engagement_style', 'availability_window', 'free_blocks_available',
  'commute_duration', 'energy_peak_time', 'energy_crash_time',
