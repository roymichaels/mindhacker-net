/**
 * Organic Sphere vertex shader — ported from Bruno Simon's organic-sphere.
 * Perlin noise functions inlined (no glslify).
 * Uniforms driven by OrbProfile + voice reactivity.
 */
...
// ── Perlin 4D Noise (Stefan Gustavson) ──
