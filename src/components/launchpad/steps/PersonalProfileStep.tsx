...
const CATEGORIES = {
  ...
  employment_status: {
    ...
    options: [
      ...
      { value: 'business-owner', label: 'בעל עסק', labelEn: 'Business Owner' },
      { value: 'self-employed', label: 'עצמאי / פרילנסר', labelEn: 'Freelancer' },
      { value: 'entrepreneur', label: 'יזם', labelEn: 'Entrepreneur' },
      { value: 'manager', label: 'מנהל/ת', labelEn: 'Manager' },
      { value: 'student', label: 'סטודנט/ית', labelEn: 'Student' },
      { value: 'military', label: 'שירות צבאי / לאומי', labelEn: 'Military / National Service' },
      { value: 'unemployed', label: 'לא עובד/ת כרגע', labelEn: 'Currently Unemployed' },
      { value: 'stay-at-home', label: 'עקרת/ן בית', labelEn: 'Stay-at-home Parent' },
