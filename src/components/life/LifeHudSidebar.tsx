/**
 * LifeHudSidebar - Left sidebar for Life System navigation.
...
import { PanelRightClose, PanelRightOpen, Heart, Eye, Dumbbell, Sun, Crosshair, TrendingUp, Swords, Brain, Crown } from 'lucide-react';
...
export function LifeHudSidebar() {
  ...
  const iconMap: Record<string, any> = {
    Eye, Dumbbell, Sun, Crosshair, TrendingUp, Swords, Brain, Crown,
  };
          ...
          <div className="w-full rounded-xl bg-gradient-to-br from-rose-500/15 to-pink-500/15 border border-rose-500/20 p-3 flex items-center justify-between">
            <div className="text-center flex-1">
              <span className="text-sm font-bold bg-gradient-to-r from-rose-500 to-pink-500 bg-clip-text text-transparent">
                {isHe ? 'מערכת חיים' : 'Life System'}
              </span>
              <p className="text-[10px] text-muted-foreground mt-0.5">
                {isHe ? '8 תחומי ביצוע' : '8 execution domains'}
              </p>
            </div>
          </div>
