  ...
  return (
    <aside
      className={cn(
        ...
        collapsed ? "w-[54px] min-w-[54px]" : "fixed top-14 bottom-14 inset-x-0 z-50 w-full lg:relative lg:top-auto lg:bottom-auto lg:inset-x-auto lg:z-auto lg:w-[260px] xl:w-[280px]"
      )}
    >
      {/* Toggle */}
      <button
