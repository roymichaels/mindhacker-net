  ...
  return (
    <aside
      className={cn(
        ...
        collapsed ? "w-[54px] min-w-[54px]" : "fixed top-14 bottom-14 z-50 ltr:left-0 rtl:right-0 w-[280px] max-w-[80vw] lg:relative lg:top-auto lg:bottom-auto lg:left-auto lg:right-auto lg:z-auto lg:w-[260px] xl:w-[280px] lg:max-w-none"
      )}
    >
      {/* Toggle */}
      <button
