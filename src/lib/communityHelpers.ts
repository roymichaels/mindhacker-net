...
export const PILLAR_SUBCATEGORIES: Record<string, PillarSubcategory[]> = {
  ...
  relationships: [
    ...
    { id: 'networking-social', en: 'Social Networking', he: 'נטוורקינג חברתי', icon: '🌐' },
    { id: 'community-belonging', en: 'Community & Belonging', he: 'קהילה ושייכות', icon: '🏘️' },
  ],
  romantics: [
    ...
    { id: 'seduction', en: 'Seduction', he: 'פיתוי', icon: '🔥' },
    { id: 'intimacy', en: 'Intimacy', he: 'אינטימיות', icon: '💋' },
    { id: 'romantic-communication', en: 'Romantic Communication', he: 'תקשורת זוגית', icon: '💬' },
    { id: 'femininity', en: 'Femininity', he: 'נשיות', icon: '🌸' },
    { id: 'sexual-energy', en: 'Sexual Energy', he: 'אנרגיה מינית', icon: '⚡' },
    { id: 'relationship-dynamics', en: 'Relationship Dynamics', he: 'דינמיקה זוגית', icon: '💞' },
    { id: 'breakups-healing', en: 'Breakups & Healing', he: 'פרידות וריפוי', icon: '💔' },
  ],
  business: [
