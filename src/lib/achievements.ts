...
export const ACHIEVEMENTS: Record<string, Achievement> = {
  ...
  first_checklist: {
    ...
    descriptionHe: 'יצרת את הצ\'קליסט הראשון שלך',
    icon: '📋',
    xp: 25,
    tokens: 3,
    category: 'exploration',
  ...
  launchpad_complete: {
    id: 'launchpad_complete',
    name: 'Launch Ready',
    nameHe: 'מוכן להמראה',
    description: 'Completed the Launchpad onboarding',
    descriptionHe: 'סיימת את תהליך ה-Launchpad',
    icon: '🚀',
    xp: 200,
    tokens: 25,
    category: 'mastery',
  ...
  first_insight: {
    ...
    name: 'Self Aware',
    nameHe: 'מודע לעצמי',
    description: 'Saved your first coaching insight',
    descriptionHe: 'שמרת את התובנה הראשונה שלך',
    icon: '💡',
    xp: 40,
    tokens: 5,
    category: 'exploration',
