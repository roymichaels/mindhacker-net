...
export default function Documentation() {
  ...
  const abstractText = he
    ...
    : `${brandName} is the first AI-powered Human Operating System — integrating Play-to-Earn mechanics, AION as the living presence layer, AION as the unified AI brain, deep gamification, AI-guided hypnosis and meditation, an adaptive learning system, an internal marketplace with 5 unified career paths, AI-powered coach matching, and full contextual awareness — into a single operating system that wraps around the user's life. This paper presents the architecture, digital economy, the AION + AION stack, the subscription model, and roadmap. The internal currency MOS (100 MOS = $1.00) is based on a Proof of Growth mechanism — a model that rewards genuine human activity.`;
  ...
  const sections: Section[] = [
      ...
      subsections: [
        {
          ...
          paragraphs: he ? [
            ...
            `AION is built on an advanced contextual pipeline that automatically gathers data from 7+ sources before every conversation: full profile, active strategic plans, missions, daily schedule, assessment scores from all 15 life pillars, and subscription tier.`,
    ...
    },
    {
      ...
      paragraphs: he ? [
        ...
        `Frontend: React + TypeScript + Tailwind CSS + Framer Motion + Three.js (AION rendering). Backend: PostgreSQL, Authentication, Server Functions, Storage, and Realtime subscriptions. AI: OpenClaw-powered AION routing across multimodal models.`,
