...
export default function Documentation() {
  ...
  const sections: Section[] = [
    ...
    },
    {
      ...
      paragraphs: he ? [
        `${brandName} אינו עוד מוצר בשוק רווי. הוא קטגוריה חדשה — Human Operating System — שמאחדת AI תודעתי עם מודעות הקשרית מלאה, כלכלה דיגיטלית מבוססת Proof of Growth, פלטפורמת קריירה מאוחדת עם 5 מסלולים מקצועיים, זהות AION NFT דינמית, Web3 Wallet עם מנטינג אמיתי, ומערכת אונבורדינג אימרסיבית — לתוך חוויה אחת שעוטפת את חיי המשתמש.`,
        `הפלטפורמה מציעה: מנוע AI שמכיר אותך לעומק, תוכנית 100 ימים עם מתודולוגיית Why-How-Now, הערכות מבוססות שיחת AI ל-15 עמודי חיים, משא ומתן חכם עם התוכנית, התאמת מאמן מבוססת AI, היפנוזה ומדיטציה מונחית, מערכת למידה אדפטיבית, שוק פנימי עם כלכלת כרייה אמיתית, פלטפורמת קריירה מאוחדת עם חנויות אישיות, קהילה פעילה, יומן AION עם חלומות ורפלקציה, מצב קולי, AION NFT עם Web3 Wallet, תוכנית שותפים, ו-PWA מלא. הכל מחובר, הכל גיימיפי, הכל בשירות הצמיחה האישית.`,
        ...
        `${brandName} is not just another product in a saturated market. It is a new category — Human Operating System — that unifies consciousness AI with full contextual awareness, a Proof of Growth digital economy, a unified career platform with 5 professional paths, dynamic AION NFT identity, Web3 Wallet with real minting, and an immersive onboarding system — into a single experience that wraps around the user's life.`,
        `The platform offers: an AI engine that deeply knows you, a 100-day plan with the Why-How-Now methodology, chat-based AI assessments for 15 life pillars, smart plan negotiation, AI-powered coach matching, guided hypnosis and meditation, an adaptive learning system, an internal marketplace with real mining economy, a unified career platform with personal storefronts, an active community, AION Journal with dreams and reflection, voice mode, AION NFT with Web3 Wallet, affiliate program, and full PWA. Everything connected, everything gamified, everything in service of personal growth.`,
