...
export default function Documentation() {
  ...
  const abstractText = he
    ...
    : `${brandName} is the first AI-powered Human Operating System — integrating Play-to-Earn mechanics, AION as the living presence layer, MindOS as the unified AI brain, deep gamification, AI-guided hypnosis and meditation, an adaptive learning system, an internal marketplace with 5 unified career paths, AI-powered coach matching, and full contextual awareness — into a single operating system that wraps around the user's life. This paper presents the architecture, digital economy, the AION + MindOS stack, the subscription model, and roadmap. The internal currency MOS (100 MOS = $1.00) is based on a Proof of Growth mechanism — a model that rewards genuine human activity.`;
  ...
  const sections: Section[] = [
      ...
      subsections: [
        {
          ...
          paragraphs: he ? [
            ...
            `MindOS is built on an advanced contextual pipeline that automatically gathers data from 7+ sources before every conversation: full profile, active strategic plans, missions, daily schedule, assessment scores from all 15 life pillars, and subscription tier.`,
    ...
    },
    {
      ...
      paragraphs: he ? [
        ...
        `Frontend: React + TypeScript + Tailwind CSS + Framer Motion + Three.js (AION rendering). Backend: PostgreSQL, Authentication, Server Functions, Storage, and Realtime subscriptions. AI: OpenClaw-powered MindOS routing across multimodal models.`,
    ...
    },
    {
      ...
      paragraphs: he ? [
        ...
        `${brandName} is not just another product in a saturated market. It is a new category — Human Operating System — that unifies AION (evolving identity + living visual presence), MindOS (the single connected AI brain), DNA (base identity layer), a Proof of Growth digital economy, a unified career platform with 5 professional paths, Web3 Wallet, and an immersive onboarding system — into a single experience that wraps around the user's life.`,
        `The platform offers: AION as your living presence, MindOS as your connected reasoning layer, a 100-day plan with the Why-How-Now methodology, chat-based AI assessments for 15 life pillars, smart plan negotiation, AI-powered coach matching, guided hypnosis and meditation, an adaptive learning system, an internal marketplace with real mining economy, a unified career platform with personal storefronts, an active community, AION Journal with dreams and reflection, voice mode, Web3 Wallet, affiliate program, and full PWA. Everything connected, everything gamified, everything in service of personal growth.`,
