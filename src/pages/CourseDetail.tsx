  ...
  if (!course) {
    return (
      <div className="relative min-h-screen">
        <MatrixRain />
        <Header />
        <div className="container mx-auto px-4 py-8 mt-20 text-center" dir="rtl">
          <h1 className="text-4xl font-black cyber-glow mb-4">קורס לא נמצא</h1>
          <Button onClick={() => navigate("/courses")}>חזור לקורסים</Button>
        </div>
      </div>
    );
  }
          ...
          <div className="lg:col-span-2 space-y-8" dir="rtl">
            ...
            <div className="glass-panel p-8 space-y-6">
              ...
              <div>
                <div className="flex flex-wrap gap-2 mb-4">
                  ...
                  {course.difficulty_level && (
                    <Badge variant="outline">רמה: {course.difficulty_level}</Badge>
                  )}
                  {course.access_level === "free" && (
                    <Badge className="bg-accent text-accent-foreground">חינם</Badge>
                  )}
                  {course.is_featured && (
                    <Badge className="cyber-glow">מומלץ</Badge>
                  )}
                </div>

                <h1 className="text-4xl md:text-5xl font-black cyber-glow mb-4">
                  {course.title}
                </h1>
              ...
              {course.requirements && course.requirements.length > 0 && (
                <div>
                  <h2 className="text-2xl font-bold mb-3">דרישות מוקדמות</h2>
                  <ul className="space-y-2">
              ...
              <CardHeader>
                <CardTitle className="text-center">
                  {course.price && course.price > 0 ? (
                    <div className="text-4xl font-black cyber-glow">₪{course.price}</div>
                  ) : (
                    <div className="text-4xl font-black text-accent">חינם</div>
                  )}
                </CardTitle>
              </CardHeader>
