...
const StorefrontSignup = () => {
  ...
  const { signup, isAuthenticated } = usePractitionerAuth();
        ...
        <Card className="w-full max-w-md text-center">
          ...
          <CardContent>
            ...
            <Button variant="outline" asChild>
              <Link to={`${baseUrl}/login`}>{t('backToLogin')}</Link>
            </Button>
          </CardContent>
        </Card>
      </div>
      ...
      <Card className="w-full max-w-md">
        <CardHeader className="text-center">
          {settings?.logo_url ? (
            ...
            <div 
              className="h-16 w-16 rounded-full flex items-center justify-center text-white font-bold text-2xl mx-auto mb-4"
