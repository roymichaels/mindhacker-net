/**
 * Learn — AION teaches you. Full curriculum system.
            ...
            <div className="text-center space-y-5 max-w-sm">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground mt-2">
                  {isHe ? 'ספר ל-Aurora מה אתה רוצה ללמוד והיא תבנה לך תוכנית אינטנסיבית.' : "Tell AION what you want to learn and it will build an intensive curriculum."}
                </p>
              </div>
