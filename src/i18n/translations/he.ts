  ...
  stats: {
   ...
   businessHub: {
    ...
    power: {
      ...
      plansNote: "תוכניות נוצרות לאחר הערכת כל עמודי התווך.",
      selectTitle: "אילו ביטויי כוח אתה רוצה לפתח?",
      ...
      lever2: "משני",
      lever3: "שלישוני",
      mod_max_strength: "כוח מקסימלי",
      mod_max_strength_desc: "הרמות מורכבות: ספסל, סקוואט, מתלה — ביחס למשקל גוף.",
      mod_relative_bodyweight: "כוח יחסי למשקל גוף",
      mod_relative_bodyweight_desc: "שכיבות סמיכה, מתח, מקבילים, L-sit — חזרות וזמן.",
      mod_static_skill_strength: "כוח מיומנות סטטית",
      mod_static_skill_strength_desc: "פלאנש, פרונט לבר, עמידת ידיים — דירוג שכבתי.",
      mod_explosive_power: "כוח נפיצי",
      mod_explosive_power_desc: "ספרינט, קפיצה אנכית, קפיצה רחבה, שכיבות סמיכה עם מחיאה.",
      mod_structural_strength: "כוח מבני",
      mod_structural_strength_desc: "תלייה, פלאנק צדדי, איזון רגל אחת, סקוואט עמוק.",
      bodyweight: "משקל גוף (ק\"ג)",
      bench1rm: "ספסל שכיבה 1RM (ק\"ג)",
      squat1rm: "סקוואט 1RM (ק\"ג)",
      deadlift1rm: "מתלה 1RM (ק\"ג)",
      maxPushups: "שכיבות סמיכה מקסימום (סט אחד)",
      maxPullups: "מתח מקסימום (סטריקט)",
      maxDips: "מקבילים מקסימום",
      lSitHold: "החזקת L-sit",
      plancheProgression: "התקדמות פלאנש",
      frontLeverProgression: "התקדמות פרונט לבר",
      handstandHold: "החזקת עמידת ידיים חופשית",
      sprint30m: "ספרינט 30 מטר",
      verticalJump: "קפיצה אנכית",
      broadJump: "קפיצה רחבה",
      clapPushups: "שכיבות סמיכה עם מחיאה (מקס)",
      deadHang: "תלייה פסיבית",
      sidePlank: "פלאנק צדדי (כל צד)",
      singleLegBalance: "איזון רגל אחת",
      deepSquatHold: "החזקת סקוואט עמוק",
      seconds: "שניות",
      tier_none: "אין",
      tier_tuck: "Tuck",
